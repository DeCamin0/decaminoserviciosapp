...
function getBrandColor() {
  const raw = config.PRIMARY_COLOR || '#CC0000';
...
const EmployeePDF = ({ employeeData, createdBy }) => {
  ...
  const logoUrl = getBrandingLogoUrlForPdf();
  const companyName =
    config.COMPANY_NAME || config.APP_NAME || employeeData?.EMPRESA || '';
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.documentDate}>
              Generado el {new Date().toLocaleDateString('es-ES')} por{' '}
              {createdBy || 'Sistema'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.content}>
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData['CORREO ELECTRONICO'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData['D.N.I. / NIE'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData.NACIONALIDAD)}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {formatDate(employeeData['FECHA NACIMIENTO'])}
              </Text>
            </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData['CENTRO TRABAJO'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData['TIPO DE CONTRATO'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData['HORAS DE CONTRATO'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {formatCurrency(employeeData['SUELDO BRUTO MENSUAL'])}
              </Text>
            </View>
              ...
              <Text
                style={[
                  ...
                  employeeData.ESTADO === 'ACTIVO'
                    ? {}
                    : employeeData.ESTADO === 'INACTIVO'
                      ? styles.statusBadgeInactive
                      : employeeData.ESTADO === 'PENDIENTE'
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {formatDate(employeeData['FECHA DE ALTA'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {formatDate(employeeData['FECHA BAJA'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {formatDate(employeeData['Fecha Antigüedad'])}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData['SEG. SOCIAL'])}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getFieldValue(employeeData['Nº Cuenta'])}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            © {new Date().getFullYear()} {companyName} - Generado automáticamente
          </Text>
        </View>
      </Page>
    </Document>
