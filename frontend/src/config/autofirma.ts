...
export const AUTOFIRMA_CONFIG = {
  // Endpoint-uri principale - folosesc proxy-ul Vite
  ENDPOINTS: {
    PREPARE: '/webhook/0f16c1e5-b9c6-4bcd-9e1d-2a7c8c62a29f', // Folosește același endpoint ca download-ul
    STATUS: '/webhook/v1/b066b1f7-cc6e-4b9e-a86f-7202a86acab4', // Endpoint pentru status
    DOWNLOAD: '/webhook/v1/b066b1f7-cc6e-4b9e-a86f-7202a86acab4' // Endpoint pentru download
  },
