...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-red-600 via-red-500 to-red-600">
      ...
      {/* Decor sezonier de Crăciun/Reyes (activ până pe 7 ianuarie) */}
      {isHolidaySeason && (
        <>
          {/* Ninsoare ușoară */}
          ...
          {/* Halo festiv în jurul cardului */}
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center z-0">
            <div className="w-[520px] h-[520px] rounded-full bg-gradient-to-br from-amber-300/8 via-red-300/10 to-orange-200/6 blur-3xl animate-pulse" />
          </div>
            ...
            {Array.from({ length: 6 }).map((_, idx) => (
              <span
                ...
                style={{
                  ...
                  animation: `sparkle ${5 + idx}s ease-in-out ${idx * 2}s infinite`
                }}
              >
                ✨
              </span>
              ...
              <div className="text-center mb-8">
                ...
                {isHolidaySeason && (
                  <div className="mt-3 flex justify-center">
                    <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/15 backdrop-blur-md border border-white/25 shadow-md">
                      <span className="text-sm">🎄 Felices Fiestas</span>
                    </div>
                  </div>
                )}
              </div>
