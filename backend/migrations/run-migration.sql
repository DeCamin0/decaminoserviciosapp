-- Run this SQL script to create FichajeRegularizacion table
-- Execute: mysql -h 217.154.102.115 -u facturacion_user -p decamino_db < run-migration.sql

-- CreateTable
CREATE TABLE IF NOT EXISTS `FichajeRegularizacion` (
