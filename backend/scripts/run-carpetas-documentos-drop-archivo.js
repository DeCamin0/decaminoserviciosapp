/**
 * DROP CarpetasDocumentos.archivo after R2 backfill (all rows have storage_key).
 * Usage:
 *   node scripts/run-carpetas-documentos-drop-archivo.js .env.decamino.local
 *   node scripts/run-carpetas-documentos-drop-archivo.js .env.hera.local
 */
