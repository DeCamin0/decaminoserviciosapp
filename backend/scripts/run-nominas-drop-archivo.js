/**
 * DROP Nominas.archivo after R2 backfill (all rows have storage_key).
 * Usage:
 *   node scripts/run-nominas-drop-archivo.js .env.decamino.local
 *   node scripts/run-nominas-drop-archivo.js .env.hera.local
 */
