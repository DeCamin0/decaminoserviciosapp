/**
 * DROP certificados_retenciones.archivo after R2 backfill (all rows have storage_key).
 * Usage:
 *   node scripts/run-certificados-retenciones-drop-archivo.js .env.decamino.local
 *   node scripts/run-certificados-retenciones-drop-archivo.js .env.hera.local
 */
